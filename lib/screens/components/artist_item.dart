...
import 'package:flip_box/screens/components/songs_modal_sheet.dart';
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Opacity(
                            opacity: 0.5,
                            child: Text("${widget.artistModel.numberOfTracks} tracks", style: TextStyle( fontSize: 12), overflow: TextOverflow.ellipsis,),
                          ),
                        ],
                      ),
                    ),
